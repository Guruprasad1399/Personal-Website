					...
					<motion.div variants={fadeInUp}>
						<Paper elevation={3} sx={{ p: 4, mb: 4, borderRadius: 3 }}>
							...
							<Typography variant="body1" paragraph>
								I specialize in a variety of technologies including Java,
								JavaScript, TypeScript, C, MongoDB, MSSQL, Node, Express, React,
								Vue, Redux, jQuery, NoSQL, Git, Spring, Spring Boot, Hibernate
								ORM, AngularJS, React-native, Kubernetes, Docker, MySQL, Python,
								GraphQL, Linux, Shell Scripting, PHP, .Net, Jenkins, Azure, AWS,
								Cloud Computing, CI/CD, JUnit, Jest, Cucumber, Unit Testing,
								Ansible, Lambda, Apache Kafka, Terraform, RabbitMQ. I have
								experience in Microservices, Distributed Systems, Frontend,
								Backend, and Full-Stack development.
							</Typography>
							<Typography variant="body1" paragraph>
								<strong>AI & Modern Development Focus:</strong> As development
								practices evolve in 2025, I'm actively expanding my expertise in
								AI technologies including LLM Integration, Prompt Engineering,
								AI Orchestration, Vector Databases, RAG (Retrieval Augmented
								Generation), and AI frameworks like LangChain and Hugging Face.
								I'm passionate about building intelligent applications that
								leverage these cutting-edge technologies while maintaining a
					...
					<motion.div variants={fadeInUp}>
						<Paper elevation={3} sx={{ p: 4, borderRadius: 3 }}>
							...
							<Typography variant="body1">
								Computer Science Tutor: Programming, Data Structure and
								Algorithms, Coding Interview Prep, Professional Portfolio.
							</Typography>
						</Paper>
					</motion.div>
				</motion.div>
